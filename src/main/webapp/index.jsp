...
<%--轮播图--%>
<div style="width: 100%;">
    <div class="layui-carousel slideDiv" id="test1" lay-filter="test1">
        <div carousel-item>
            <div>
                <a href="javascript:">
    ...
    <div class="movie-container selectDiv">
        <ul class="selectList" id="select1">
            <span>频道：</span>
            <li style="background: #1E9FFF"><a href="javascript:void (0);" style="color: #fff;" typeId="0">全部</a></li>
        ...
        <ul class="selectList" id="select2">
            <span>类型：</span>
            <li style="background: #1E9FFF"><a href="javascript:void (0);" style="color: #fff;" categoryId="0">全部</a></li>
        </ul>
        <hr>
        <ul class="selectList" id="select3">
            <span>地区：</span>
            <li style="background: #1E9FFF"><a href="javascript:void (0);" style="color: #fff;">全部</a></li>
...
<script type="text/javascript">
  ...
  function showCategory(pid) {
    var categoryResult = " <span>类型：</span> <li style=\"background: #1E9FFF\"><a href=\"javascript:void (0);\" style=\"color: #fff;\" categoryId='0'>全部</a></li> ";
