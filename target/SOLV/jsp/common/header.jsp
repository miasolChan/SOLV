...
<style type="text/css">
    body .login-class .layui-layer-title{font-size: 20px;color: #ffffff;}
...
<div class="movie-header all-container" >
    <div class="layui-container" style="width: 80%;" >
        ...
        <a href="index.jsp" style="position: relative">
            <img style="width: 50px;height: 50px" src="static/images/logoP.png" alt="logo">
            <span class="movie-logo-font">SOLV</span>
        </a>
    ...
    --%><button type="button" class="layui-btn layui-btn-normal" onclick="showSearchTip()" style="vertical-align: middle;border-bottom-right-radius: 5px;border-top-right-radius: 5px; " >
        ...
        <%--用户头像--%>
        <ul class="layui-nav fly-nav-user" style="background: #ffffff;">
            <li class="layui-nav-item">
                <a class="fly-nav-avatar" href="javascript:">
                    <img src="static/images/用户.png">
                    <cite class="layui-hide-xs" style="color: #8b8b8b;margin-left: 5px;"></cite>
                </a>
    ...
    <%--后台登录链接--%>
    <a href="jsp/manager/login.jsp" target="_blank" style="position: absolute;right: 30px;top: 0;line-height: 60px;background-color: #1E9FFF;padding: 0 30px">
        <span style="text-align: center;vertical-align: middle;color: #ffffff;">
            进入后台
        </span>
    </a>
